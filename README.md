...
| `/history` | ผลการแข่งขันย้อนหลัง | Viewer/Admin | แสดงเฉพาะรายการที่มีรอบเริ่มและจบแล้ว, กรองประเภท, นำเข้าทั้งประเภทหรือเลือกรายรอบ และเล่นข้อมูลย้อนหลัง |
...
หน้าผลย้อนหลังเริ่มจากโหลดรายการแข่งขันทั้งหมดจาก SailFish เลือกรายการ แล้วกด
โหลดประเภทและรอบ ระบบจะแสดงเฉพาะประเภทที่มีรอบจบ เมื่อเลือกประเภทเรือแล้ว
จึงแสดงเฉพาะรอบที่เริ่มและจบจริงสำหรับนำเข้าทีละรอบหรือนำเข้าทั้งประเภท หลัง
นำเข้าสำเร็จ Admin ต้องกด **เปิดผลย้อนหลังให้คนทั่วไปดู** ของประเภทนั้น การเปิด
History นี้ไม่เปิดการถ่ายทอดสดของประเภทเดียวกันโดยอัตโนมัติ
...
| GET | `/races/discover` | ค้นหาและบันทึกรายการแข่งขันทั้งหมดจาก SailFish โดยอ่านครบทุกหน้า |
